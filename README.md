...
- 🧠 **Learning** — low-level systems, RISC-V architecture & hardware description with Verilog
- 🔬 **Exploring** — where embedded systems meet machine learning (tinyML is wild)
- ☁️ **Dipping into** — cloud-native architectures and how they connect to edge devices
...
- 🔩 **Embedded / hardware hacking** — microcontrollers, FPGAs, bare-metal anything
- 🌐 **Open source projects** — especially at the intersection of hardware + software
- 🤔 Got a weird low-level problem? I'm probably interested

---

## ⚡ Fun Facts

- 💡 I *think* I think in bits and bytes — turns out I mostly think in bugs
- 📄 Datasheets are just the universe's way of punishing curiosity
- 🌌 Fascinated by how a few transistors became the world we live in (still not reading the datasheet about it)
- 🎯 Current obsession: getting ML to run on things with *no right* running ML
- ☕ My code compiles on the first try — said no one, ever, including me
